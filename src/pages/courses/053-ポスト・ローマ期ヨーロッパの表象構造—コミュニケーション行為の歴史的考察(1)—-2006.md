...
attachments:
  ...
  - name: "5〜7回参考資料：ラテン語の会話の消滅" 
    path: /files/53/reference567.ppt
  - name: "9回参考資料：キルペリクス指令" 
    path: /files/53/reference9.ppt
  - name: "12回参考資料：北海・エヒテルナッハ" 
    path: /files/53/reference12.ppt
  - name: "11〜12回参考資料：エヒテルナッハ図版" 
    path: /files/53/reference1112.ppt
  - name: "8回参考資料：文字表象の理路関連地図" 
    path: /files/53/reference8.pdf
  - name: "佐藤彰一先生画像" 
    path: /files/53/sato.jpg
...
-
[文字表象の理路関連地図](https://ocw.nagoya-u.jp/files/53/reference8.pdf) 
...
-
[キルペリクス指令](https://ocw.nagoya-u.jp/files/53/reference9.pdf) 
...
-
[エヒテルナッハ図版](https://ocw.nagoya-u.jp/files/53/reference1112.pdf) 
