...
# 映像のURL
## なにも指定がない場合は画像が表示される
featuredmovie: https://nuvideo.media.nagoya-u.ac.jp/embed/89c967d6f0e2b6618b58e33345942ccb3145b1b5
...
file="oxford_bookworms.pdf" desc="Oxford Bookworms"}

* {ocwlink

file="heinemann.pdf" desc="Heinemann"}

* {ocwlink

file="cambridge.pdf" desc="Cambridge"}

* {ocwlink

file="penguin.pdf" desc="Penguin"}

* {ocwlink

file="oxford_factfiles.pdf" desc="Oxford Factfiles"}
...
book report number（book reportの通し番号、つまり何枚目のレポートか）
...
* Series（略号・{ocwpagelink

type="relatedresources" desc="表１"}）

* Book

No（本の通し番号・本の表紙又はbook list）

* Grade（授業で使う段階分け・{ocwpagelink

type="relatedresources" desc="表３"}）

* Page

count（総ページ数・book listより）

* Word

count（総単語数・book listより）
...
i - 1 〜 i + 1 であること（注: i は自分の今の英語のレベル）
