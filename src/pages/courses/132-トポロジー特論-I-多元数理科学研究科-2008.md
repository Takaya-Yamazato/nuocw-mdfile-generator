...
![Definition of Delta of n](/files/132/simplex.gif) 
...
Hovey, Model Categories, Mathematical Surveys and Monographs, vol. 63, American Mathematical Society.

* Daniel

G. Quillen, Homotopical Algebra, Lecture Notes in Mathematics, vol. 43, Springer-Verlag, New York.

* Friedhelm

Waldhausen, Algebraic K-theory of spaces, Lecture Notes in Mathematics, vol. 1126, Springer-Verlag, New York.
...
file="ps1.pdf" desc="Problem set 1."}

* {ocwlink

file="ps2.pdf" desc="Problem set 2."}
