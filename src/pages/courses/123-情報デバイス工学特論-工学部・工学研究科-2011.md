...
file="design.pdf" desc="情報デバイス特論演習 設計ルール"}

* {ocwlink

file="r_report.pdf" desc="情報デバイス特論レポート問題 CMOS 基本回路60選"}

* {ocwlink

file="r_Example1.pdf" desc="例題1 CMOS インバーターの解析"}

* {ocwlink

file="r_Example2.pdf" desc="例題2 Schmitt trigger 回路の解析"}

* {ocwlink

file="r_practice.pdf" desc="演習問題"}
