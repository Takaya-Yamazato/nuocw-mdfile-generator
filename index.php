...
$calendar = get_contents_without_Markdownify ($calendar_sql) ;
...
$assignment = get_contents_without_Markdownify($assignments_sql) ;
...
$file_name = "./src/pages/courses/".$sort_key."-".$course_name."-".$division.".md" ;
